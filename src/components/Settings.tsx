...
const Settings: React.FC = () => {
  ...
  return (
    <div className={`text-xl ${containerClass}`} onClick={stopPropagation}>
      <div className="flex flex-col max-w-[1200px] sm:min-w-[800px] h-fit mx-4 sm:mx-0 py-6 px-6 bg-white rounded-xl shadow-lg">
        ...
        <div className="flex justify-between items-center gap-20 mt-8">
          <div className="flex flex-col gap-2">
            <span className="text-black text-xl">
              {t("autosave.auto_save")}
            </span>
            <span className="text-gray-500 text-sm">
              {t("autosave.auto_save_description")}
            </span>
          </div>
          <AutoSave />
        </div>
